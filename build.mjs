// Sestaví stredozem.html ze šablony: vloží obrázky z assets/ jako base64 data URI.
// Spuštění:  node build.mjs
//
// Tokeny v šabloně stredozem.template.html:
//   __MAP_DATA_URI__   -> assets/map.jpg           (mapa Středozemě)
//   __IMG_<id>__       -> assets/portraits/<id>.jpg (portréty postav)
//   __SCENE_<n>__      -> assets/scenes/<n>.jpg      (ilustrace kapitol 1..22)
//
...
const TEMPLATE = path.join(ROOT, 'stredozem.template.html');
const OUT = path.join(ROOT, 'stredozem.html');
